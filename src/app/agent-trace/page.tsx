...
export default function AgentTracePage() {
  return (
    // Breaks out of the site's shared 1440px content width for this page only —
    // the trace graph benefits from extra horizontal room that other tools don't need.
    <div className="ml-[calc(50%-50vw)] mr-[calc(50%-50vw)] w-screen overflow-x-hidden">
      <div className="mx-auto flex w-full max-w-[1800px] flex-col px-4 sm:px-6">
